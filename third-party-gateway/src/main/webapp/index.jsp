   ...
   <table border="1" width="800" align="center">
      ...
      <tr>
       ...
       <tr>
        <td>消息时长</td>
        <td>
          <input name="messageTime" type="checkbox" id="msg1" value="day">day <br>
           <input name="messageTime" type="checkbox" id="msg2" value="week">week <br>
            <input name="messageTime" type="checkbox" id="msg3" value="month">month <br>
             <input name="messageTime" type="checkbox" id="msg4" value="year">year <br>
              <input name="messageTime" type="checkbox" id="msg5" value="never">never <br><font color="red">*</font>
         </td>
      </tr>
       <tr>
        <td>应用描述</td>
       ...
       <tr>
        <td colspan="2" align="center"><input type="reset" value="重置"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="提交" onclick="submit_form()"> </td>
      </tr>
   </table>
</form>
</body>
