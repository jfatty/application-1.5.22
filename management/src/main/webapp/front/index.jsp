...
<body class="bg_body">
<iframe  allowtransparency="true" framespacing="0" frameborder="0" scrolling="no" width="100%" height="90" src="<%=path %>/front/header.jsp"></iframe>
<div class="middle" style="width:902px;margin:0 auto;padding-top:10px;">
  <iframe name="front_main" allowtransparency="true" framespacing="0" frameborder="0" scrolling="no" width="132" height="510" src="<%=path %>/front/menu.jsp" id="menu" name="menu" target="main"></iframe>
  <iframe allowtransparency="true" framespacing="0" frameborder="0" scrolling="auto" width="760" height="510" src="<%=path %>/queryUser.action" id="main" name="main" target="_self"></iframe>
</div>
<iframe allowtransparency="true" border="0" vspace="0" hspace="0" marginwidth="0" marginheight="0" framespacing="0" frameborder="0" scrolling="no" width="100%" height="90" src="<%=path %>/front/footer.html"></iframe>
...
<div  class="pop_box">
 ...
 <form action="<%=path %>/updatePass.action" id="forms">
  ...
  <tr>
    <th>再次输入新密码：</th>
    <td><input name="newPass1" id="newPass1" value="" type="password" maxlength="14" class="inputText"/></td>
  </tr>
  <tr class="bu_input03" style="text-align:center;">
    <td colspan="2" style="text-align:center;"><input class="kill_box" type="button" value="确 定" style="display:inline;"/>&nbsp;<input id="kill_box" type="button" value="取消" style="display:inline;"/></td>
  </tr>
</table>
</form>
</div> 
