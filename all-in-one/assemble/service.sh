...
JAVA_OPTS="-Djava.net.preferIPv4Stack=true -Xms1024m -Xmx1024m -Xmanagement:ssl=false,authenticate=false,autodiscovery=false,port=7093"

#APP_OPTS="-m $2 -d $3 -g $4 -gs $5 -dn $6"

MAIN_CLASS="com.babeeta.butterfly.all.JvmServices"
